 ...
 */
import { ReactNode, Dispatch, SetStateAction, MutableRefObject, ReactPortal, CSSProperties } from 'react';
import { TypeSortInfo } from './TypeSortInfo';
import { TypeGroupBy } from './TypeGroupBy';
import { TypeSize } from './TypeSize';
import { TypeColumn, TypeComputedColumn, TypeComputedColumnsMap, TypeSummaryReducer, IColumn, TypeColumnGroup, TypeColumns } from './TypeColumn';
import { TypeDataSource } from './TypeDataSource';
import { TypeComputeTreeData, TypeComputeTreeDataParam } from './TypeComputeTreeData';
import { TypeFilterValue, TypeFilterTypes, TypeSingleFilterValue } from './TypeFilterValue';
import { TypePaginationProps } from './TypePaginationProps';
import { TypeShowCellBorders, TypeRowProps, TypeLockedRow, TypeCollapsedGroups, TypeShowGroupSummaryRow, TypeBatchUpdateQueue, TypeCellProps, TypeGetColumnByParam, TypeExpandedRows, TypeCollapsedRows, TypeDetailsGridInfo, TypeExpandedNodes, TypeNodeCache, TypeNodeProps, TypeEditInfo, TypeDataSourceCache, TypeStickyRows, TypeFooterRow, TypePivotItem, TypePivotColumnSummaryReducer, TypeExpandedGroups } from '.';
import { TypeRowSelection, TypeCellSelection, TypeRowUnselected } from './TypeSelected';
import Renderable from './TypeRenderable';
export declare type TypeBuildColumnsProps = {
    groups: any;
    checkboxColumn: any;
    groupBy: any;
    groupColumn: any;
...
declare type TypeI18n = {
    [key: string]: string | ReactNode;
};
declare type TypeNumberMap = {
    [key: string]: number;
};
declare type TypeBoolMap = {
    [key: string]: boolean;
};
export declare type TypeOnSelectionChangeArg = {
    selected: TypeRowSelection;
    data?: object;
    unselected?: TypeRowSelection;
};
export declare type TypeRowDetailsInfo = {
    id: string | number;
    data: object;
    rowSelected: boolean;
    rowActive: boolean;
...
declare type TypeRowReorderParam = {
    dragRowIndex?: number;
    insertRowIndex?: number;
};
declare type TypeRenderLockedCells = (arg: {
    rtl: boolean;
    scrollLeft: number;
...
export declare type TypeRowReorderFn = ({ dragRowIndex, insertRowIndex, }: TypeRowReorderParam) => void;
export declare type TypeRowReorder = TypeRowReorderFn | boolean;
export declare type TypeRowExpandHeightFunction = ({ data }: {
    data: any;
}) => number;
export declare type EnumRowDetailsWidth = 'max-viewport-width' | 'min-viewport-width' | 'viewport-width';
declare type TypeGridPublicAPI = any;
declare type TypeDataGridPropsNoI18n = {
    ...
    headerHeight?: number;
    renderRowContextMenu?: (menuProps: any, details: {
    ...
    rowContain?: string;
    onScroll?: () => void;
    onRowCollapse?: ({ data, id, index, }: {
        data: object;
        id: string | number | null;
        index: number;
    }) => boolean;
    onRowExpand?: ({ data, id, index, }: {
        data: object;
        id: string | number | null;
        index: number;
    }) => boolean;
    onRowExpandChange?: ({ expandedRows, collapsedRows, data, id, index, rowExpanded, }: {
        rowExpanded: boolean;
        expandedRows: {
            [key: string]: boolean;
        } | true | undefined;
    ...
    onExpandedRowsChange?: ({ expandedRows, collapsedRows, data, id, index, rowExpanded, }: {
        rowExpanded: boolean;
        expandedRows: {
            [key: string]: boolean;
        } | true | undefined;
    ...
    onDataSourceCacheChange?: (dataSourceCache: TypeDataSourceCache, info?: {
    ...
    renderDetailsGrid?: (rowDetailsInfo: TypeRowDetailsInfo, detailsProps: any) => ReactNode;
    renderColumnContextMenu?: (menuProps: any, other: {
        cellProps: TypeCellProps;
        grid: TypeGridPublicAPI;
        computedProps: TypeComputedProps;
    ...
    columnFilterContextMenuConstrainTo: boolean | HTMLElement | string | ((...args: any[]) => HTMLElement);
    ...
    renderGroupTitle?: (value: string, rowProps: {
        data: {
            keyPath: string[];
            fieldPath: string[];
            array: any[];
    ...
    renderGroupTool?: (domProps: any, { collapsed, toggleGroup, }: {
        collapsed: boolean;
        toggleGroup: (group: any) => boolean;
    }) => string | ReactNode;
    ...
    onDidMount?: (computedPropsRef: MutableRefObject<TypeComputedProps | null>) => void;
    onDetailsDidMount?: (computedPropsRef: MutableRefObject<TypeComputedProps | null>) => void;
    onWillUnmount?: (computedPropsRef: MutableRefObject<TypeComputedProps | null>) => void;
    onDetailsWillUnmount?: (computedPropsRef: MutableRefObject<TypeComputedProps | null>) => void;
    __parentRowInfo?: any;
    onSelectionChange?: (config: TypeOnSelectionChangeArg) => void;
    onCellSelectionChange?: (value: {
        [key: string]: boolean;
    }) => void;
    keyPageStep: number;
    activeIndex?: number;
    ...
    onColumnLockedChange?: ({ column, locked, }: {
        column: TypeColumn;
        locked: 'start' | 'end' | false;
    }) => void;
    onBatchColumnResize?: (info: {
        column: TypeColumn;
        width?: number;
        flex?: number;
    ...
    onNodeCache?: (nodeCache: TypeNodeCache, info?: {
        nodeId: string | number;
        node: object;
    }) => void;
    loadNode?: ({ node, nodeProps, }: {
        node: object;
        nodeProps: TypeNodeProps;
    }) => object[] | Promise<object[]>;
    loadNodeOnce?: ({ node, nodeProps, }: {
        node: object;
        nodeProps: TypeNodeProps;
    }) => object[] | Promise<object[]>;
    ...
    renderColumnFilterContextMenu?: (menuProps: any, { cellProps, grid, props, }: {
        cellProps: TypeCellProps;
    ...
    onUpdateRowHeights?: (heights: {
        [key: number]: number;
    }, computedProps: TypeComputedProps) => void;
    ...
    onGroupCollapseChange?: (collapsedGroups: TypeCollapsedGroups, expandedGroups: TypeExpandedGroups) => void;
    ...
    renderRowReorderProxy?: ({ data, dataSource, dragRowIndex, }: {
        data: any;
        dataSource: TypeDataSource;
        dragRowIndex: number;
    }) => void;
    isRowReorderValid?: ({ dragRowIndex, dropRowIndex, dragRowData, dropRowData, }: {
        dragRowIndex: number;
        dropRowIndex: number;
        dragRowData: any;
        dropRowData: any;
    ...
    onTreeRowReorderEnd?: ({ updatedTreeData, }: {
        updatedTreeData: any[];
    }) => void;
...
declare type TypeDataGridComputedClashingProps = {
    i18n?: TypeI18n;
};
export declare type TypeDataGridProps = TypeDataGridPropsNoI18n & TypeDataGridComputedClashingProps;
export declare type TypePivotUniqueValuesDescriptor = {
    field: string | null;
    values: {
        [key: string]: TypePivotUniqueValuesDescriptor;
    } | null;
};
export declare type TypeComputedProps = TypeDataGridPropsNoI18n & {
    ColumnLayout?: any;
    ...
    getScrollTop: () => number;
    scrollToIndex: (index: number, config?: {
        top?: boolean;
    ...
    scrollToId: (id: string | number, config?: {
        top?: boolean;
        direction?: 'top' | 'bottom';
        force?: boolean;
        duration?: number;
    ...
    scrollToColumn: (index: number, config: {
        offset?: number;
        duration?: number;
        force?: boolean;
    ...
    scrollToIndexIfNeeded: (index: number, config?: {
        ...
        duration?: number;
        offset?: number;
    }, callback?: (...args: any) => any) => boolean;
    getColumnBy: (idNameOrIndex: string | number | TypeComputedColumn | {
        id: string | number;
        name?: string | number;
    } | {
        name: string | number;
    ...
    setLockedColumnsState: Dispatch<SetStateAction<{
        [key: string]: 'start' | 'end' | false;
    }>>;
    ...
    setDataMap: (dataMap: null | {
        [key: string]: any;
    }) => void;
    dataIndexMap: null | {
        [key: string]: number;
    };
    setDataIndexMap: (dataMap: null | {
        [key: string]: number;
    }) => void;
    ...
    getCellSelectionKey?: (cellProps: number | TypeCellProps | string, col?: TypeGetColumnByParam) => string | number;
    setActiveCell: (activeCell: [number, number] | null, queue?: TypeBatchUpdateQueue) => void;
    ...
    onCellClickAction: (event: {
        shiftKey?: boolean;
        metaKey?: boolean;
        ctrlKey?: boolean;
    }, cellProps: TypeCellProps) => void;
    getCellSelectionBetween: (start?: [number, number] | null, end?: [number, number] | null) => {
        [key: string]: boolean;
    };
    getContinuousSelectedRangeFor: (selectionMap: {
        [key: string]: boolean;
    }, cell: any) => [number, number][];
    ...
    setListenOnCellEnter: (value: boolean, callback: (...args: any[]) => void) => void;
    ...
    clearNodeChildrenCache: (nodeId: string | number, recursive: boolean, treeCache: TypeNodeCache | undefined, clearedMap?: {
        [key: string]: boolean;
    }, callback?: () => void) => void;
    ...
    getColumnFilterValue: (idNameOrIndex: TypeGetColumnByParam) => TypeSingleFilterValue;
    ...
    useCellSelection: (props: TypeDataGridProps, arg: any, computedPropsRef: MutableRefObject<TypeComputedProps | null>) => any;
    ...
    tryStartEdit?: ({ rowIndex, columnId, dir, }: {
        rowIndex: number;
        columnId: number | string;
        dir: number;
    }) => void;
    startEdit?: ({ rowIndex, rowId, columnId, dir, value, }: {
        rowIndex?: number;
        rowId?: string;
        columnId: string;
        dir: number;
    ...
    completeEdit?: ({ rowId, rowIndex, dir, columnId, value, }: {
        rowId?: string;
        rowIndex?: number;
        dir: number;
        columnId: string;
