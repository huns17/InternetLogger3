...
declare const ReactDataGrid: {
    ...
    defaultProps: {
        ...
        theme: string;
        filterTypes: {
            select: import("./types").TypeFilterType;
            string: import("./types").TypeFilterType;
            number: import("./types").TypeFilterType;
            bool: import("./types").TypeFilterType;
            boolean: import("./types").TypeFilterType;
            date: {
                type: string;
                emptyValue: string;
                operators: {
